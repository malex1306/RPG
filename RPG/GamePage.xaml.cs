...
namespace TextAdventure
{
    ...
    {
        private string _fullText = "Du erwachst in einer zerfallenen Hütte am Rand von Celmora, einer Stadt, die einst voller Leben war, nun aber von Dunkelheit verschlungen wird.\n\nSeit Tagen hörst du Gerüchte über das Herz der Ewigkeit, ein mächtiges Artefakt, das das Schicksal von Celdoria bestimmen könnte!\n\n" +
                                   "Wie heisst du Held?";
